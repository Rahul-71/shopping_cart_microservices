...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse getOrderDetails(long orderId) {
        ...
        log.info("Invoking PRODUCT SERVICE to fetch the productDetaisl for productId: {}", orderDetails.getProductId());
        ...
        PaymentDetails paymentDetails = this.restTemplate.getForObject(
